...
tooltip:	""
icon:	"across:2|control:spinner|id:SPIN_base_to_support_gap|type:#INTEGER|fieldwidth:24|range:[ 1, 99, 20 ]|scale:1|offset:[ -60, 8 ]|tooltip:how many layers is prented between support base and source object ( avoid glue of supports and printed object )"
(
	on execute do
